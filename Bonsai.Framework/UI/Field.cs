...
{
    public enum eTextAlignment { Left, Right, Center }
    public enum eDisplayMode { LabelOnly, ValueOnly, LabelAndValue }
    ...
    public interface IField
    {
        ...
        void Draw(SpriteBatch batch, Color force_to_color, bool recolor_icon_aswell);
    }

    public class Field<T> : IField
    {
        public Field(SpriteFont font, string label, T value, eDisplayMode display_mode)
        {
            this.font = font;
        ...
        eDisplayMode display_mode = eDisplayMode.LabelOnly;
        ...
        public eTextAlignment Alignment
        {
        ...
        void process()
        {
            switch (display_mode)
            {
                case eDisplayMode.LabelOnly:
                    process_labelonly();
                    break;

                case eDisplayMode.ValueOnly:
                    process_valueonly();
                    break;

                case eDisplayMode.LabelAndValue:
